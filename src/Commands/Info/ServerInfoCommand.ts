...
export class ServerInfoCommand {
  ...
  async ServerInfoSlash(interaction: CommandInteraction) {
    ...
    const channels = guild.channels.cache
      .filter(
        (c) =>
          c.type !== ChannelType.GuildCategory && // skip categories
    ...
    const embed = new EmbedBuilder()
      ...
      .addFields(
        ...
        { name: "Role List", value: rolesValue },
        { name: "Channel List", value: channelsValue }
      )
  ...
  async ServerInfoMessage(command: SimpleCommandMessage) {
